...
export function DataTable<TData, TValue>({
  ...
  // Sinkronisasi input pencarian ke state filter tabel
  React.useEffect(() => {
    startTransition(() => {
        ...
        <div className="flex items-center gap-4 sm:gap-6">
          <div className="flex items-center space-x-2">
            ...
            >
              <SelectTrigger className="h-8 w-17.5 bg-white border-slate-200 rounded-lg text-xs font-bold">
                {/* FIX: Tambahkan placeholder untuk kestabilan hydration */}
                <SelectValue
          ...
          <div className="flex items-center space-x-2">
            ...
            <Button
              ...
              className="h-9 w-9 p-0 rounded-lg hover:text-blue-600 transition-all shadow-sm"
            >
